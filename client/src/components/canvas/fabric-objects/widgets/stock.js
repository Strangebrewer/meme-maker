...
fabric.Stock = fabric.util.createClass(fabric.Group, {
    type: 'stock',
...
fabric.Stock.async = true;
fabric.Stock.fromObject = function (object, callback) {
    fabric.util.enlivenObjects(object.objects, function (enlivenedObjects) {
        fabric.util.enlivenObjects([object.clipPath], function (enlivedClipPath) {
            const options = fabric.util.object.clone(object, true);
            options.clipPath = enlivedClipPath[0];
            delete options.objects;
            callback && callback(new fabric.Stock(enlivenedObjects, options, true));
        });
    });
};
